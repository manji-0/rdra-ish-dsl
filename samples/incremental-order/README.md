...
| `step-3-interaction-boundary` | screens, APIs, system ownership, and access/media constraints | `rdra-ish csv ... --kind screen-constraints`, `rdra-ish csv ... --kind actor-permission-audit` |
...
medium requirements pass through each screen, and `rdra-ish csv ... --kind
actor-permission-audit` to see which actor-side grants are inferred as ok, missing, or
excess. Step 4 adds systems by assigning APIs to system boundaries.
