...
rdra-ish diagram samples/incremental-order/step-5-lifecycle/src --kind object-graph --format mermaid --buc BucStoreRestock --out samples/incremental-order/step-5-lifecycle/out/object_graph_buc_store_restock
