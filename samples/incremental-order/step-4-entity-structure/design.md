...
rdra-ish csv samples/incremental-order/step-4-entity-structure/src --kind actor-permission-audit --out samples/incremental-order/step-4-entity-structure/out/actor_permission_audit.csv
```
